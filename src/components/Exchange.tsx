...
import { Segment, Header, Divider, Form, Dropdown, DropdownItemProps, Input } from 'semantic-ui-react';
...
export const Exchange = () => {
    ...
    return (
        <Segment>
            <Header fluid as='h3'>Currency Exchange : {currentCurrency}</Header>
            <Form>
                ...
                <Form.Field>
                    <Input onChange={updateSum} value={sum} type="number" label={<Dropdown defaultValue={currentCurrency} options={currencyOptions} />} labelPosition='right' />
                </Form.Field>
                <Divider />
                <Form.Field>
